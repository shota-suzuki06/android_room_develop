package com.example.android_room_develop.fragments.update
...
class UpdateFragment : Fragment() {
    ...
    private fun updateItem() {
        ...
        if (inputCheck(firstName, lastName, updateAge_et.text)) {
            ...
            Toast.makeText(requireContext(), "ユーザ情報を更新しました", Toast.LENGTH_SHORT).show()
            findNavController().navigate(R.id.action_updateFragment_to_listFragment)
        } else {
            Toast.makeText(requireContext(), "入力情報に誤りがあります", Toast.LENGTH_SHORT).show()
        }
    }
